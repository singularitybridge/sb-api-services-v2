...
import { FunctionFactory, ActionContext, StandardActionResult } from '../integrations/actions/types'; // Import StandardActionResult
...
interface UpdateEventData { message: string } 
interface DeleteEventData { message: string } // Or specific data
...
export const createCalendarActions = (context: ActionContext): FunctionFactory => ({
  createEvent: {
    ...
    function: async (args: IEventRequestBody): Promise<StandardActionResult<CreateEventData>> => {      
  ...
  updateEvent: {
    ...
    function: async (args: { id: string; eventData: IEventRequestBody }): Promise<StandardActionResult<UpdateEventData>> => {      
      ...
      if (typeof updateResponse === 'object' && updateResponse !== null && 'message' in updateResponse) {
  ...
  deleteEvent: {
    ...
    function: async (args: { id: string }): Promise<StandardActionResult<DeleteEventData>> => {      
