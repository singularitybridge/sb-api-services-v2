...
export async function getContacts(
  ...
  console.log('[NYLAS DEBUG] Getting contacts:', { limit, email });
  ...
  console.log('[NYLAS DEBUG] Got contacts:', response.data?.length || 0);
...
export async function createContact(
  ...
  console.log('[NYLAS DEBUG] Creating contact:', payload);
  ...
  console.log('[NYLAS DEBUG] Contact created:', contactData.id);
...
export async function updateContact(
  ...
  console.log('[NYLAS DEBUG] Updating contact:', contactId, payload);
  ...
  console.log('[NYLAS DEBUG] Contact updated:', contactData.id);
