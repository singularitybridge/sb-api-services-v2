/**
 * Execute Assistant Tool - Direct Service Integration
 *
 * Calls the assistant execution service directly (no HTTP overhead)
 */
 ...
 */
export async function executeAssistantDirect(
