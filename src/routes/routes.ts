...
const models: TsoaRoute.Models = {
    "IEventResponse": {
        ...
        "properties": {
            ...
            "formattedStartDate": {"dataType":"string","required":true},
            "formattedEndDate": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/calendar/events',
            ...
            function CalendarController_getEvents(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/calendar/free-slots',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.getFreeSlots)),

            function CalendarController_getFreeSlots(request: any, response: any, next: any) {
            const args = {
                    start: {"in":"query","name":"start","required":true,"dataType":"string"},
                    end: {"in":"query","name":"end","required":true,"dataType":"string"},
                    duration: {"in":"query","name":"duration","dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.getFreeSlots.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/calendar/calendars',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.getCalendars)),

            function CalendarController_getCalendars(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getCalendars.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/calendar/events',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.createEvent)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/calendar/events/:id',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.updateEvent)),
            ...
            try {
              ...
              const promise = controller.updateEvent.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/calendar/events/:id',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.deleteEvent)),

            function CalendarController_deleteEvent(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
        ...
        app.get('/calendar/oauth2callback',
            ...(fetchMiddlewares<RequestHandler>(CalendarController)),
            ...(fetchMiddlewares<RequestHandler>(CalendarController.prototype.handleOAuth2Callback)),

            function CalendarController_handleOAuth2Callback(request: any, response: any, next: any) {
            const args = {
